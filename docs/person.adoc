...
We are going to use https://www.reacttutorial.com/css-modules-react[css modules^] to style this component.

To do that, create a `Person.module.css` file with the following content:
