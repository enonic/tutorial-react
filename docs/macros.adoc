...
This component takes care of mapping each macro to it's corresponding React component. In our case, `FactBox` component implements the macro called `com.enonic.app.intro:factbox` in Enonic.
