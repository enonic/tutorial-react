...
Now, add the component itself (note the new `components` folder):
...
The component will also require some styling, to make it look good! Add the stylesheet for the PersonList component (note the new `styles` folder):
