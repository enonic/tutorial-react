...
First, we need to create a `src/queries/personList.ts` file with query to fetch the data:
...
Clicking on any of the images will take you to the person's page which we will implement in the next chapter.
