...
Now you should see a grid of 9 images at http://localhost:3000[http://localhost:3000].

image::./person-list.png[width=1200]

Clicking any of the images will take you to the person's page which we will implement in the next chapter.
